...
@powershell -NoProfile -ExecutionPolicy unrestricted -Command "Invoke-WebRequest https://raw.githubusercontent.com/omtinez/initscripts/master/linux/gitsetup.sh -OutFile ~/Bin/GitSetup.ps1"
